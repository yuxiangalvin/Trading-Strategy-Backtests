...
import datetime
def strategy_backtest2_loss(Tele2, trade_day_list, base_time_start, base_time_end, test_time_start, test_time_end, sma_threshold, stop_threshold, bounce_stop_threshold, trade_cost):
