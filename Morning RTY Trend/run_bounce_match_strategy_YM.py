# -*- coding: utf-8 -*-
"""
Created on Fri Jul 26 14:56:09 2019
...
Tele2 = ts.Telescope()
Tele2.load_dfs([r"Z:\KaiData\Theo\2019\YM.ESTheo.mpk"])
...
#
#criteria_df = criteria_df[(criteria_df['Log Vol NQ Diff ratio'] <= 1.3) & (criteria_df['Log Vol NQ Diff ratio'] >= 0.9)]
...
over_limit_time_list = [50,100,150,200,250,300,350,400]
...
result_df.to_excel("C:\\Users\\achen\\Desktop\\Monocular\\Automatic Backtest\\YM Morning Trend PL\\YM_20190101_20190725_BOUNCE_MATCH_VARIOUS_PARAM_NO_FILTER.xlsx")
