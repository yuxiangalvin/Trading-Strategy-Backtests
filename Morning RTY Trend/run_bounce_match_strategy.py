...
END = datetime.datetime(2019, 7, 29, 23, 59)
...
#criteria_df = criteria_df.resample('1T')
...
criteria_df = criteria_df[criteria_df['Abs Diff'] > 0]
...
criteria_df = criteria_df[(criteria_df['Log Vol RTY Diff ratio'] <= 1.4) & (criteria_df['Log Vol RTY Diff ratio'] > 0)]
#criteria_df = criteria_df[(criteria_df['Log Vol ES RTY ratio'] >= 1.4) | (criteria_df['Log Volume RTY'] >= 800)]
...
#daily_df.to_excel("C:\\Users\\achen\\Desktop\\Monocular\\Automatic Backtest\\RTY Morning Trend PL\\RTY_20160101_20161231_BOUNCE_MATCH_FINAL_BACKTEST_with_FILTER_DAILY_RECORD).xlsx")
#result_df.to_excel("C:\\Users\\achen\\Desktop\\Monocular\\Automatic Backtest\\RTY Morning Trend PL\\RTY_20160101_20161231_BOUNCE_MATCH_FINAL_BACKTEST_with_FILTER.xlsx")
