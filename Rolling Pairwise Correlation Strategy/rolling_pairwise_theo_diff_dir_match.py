# -*- coding: utf-8 -*-
"""
Created on Thu Jul 18 15:42:55 2019

@author: achen
"""

import datetime
def rolling_pairwise_theo_diff_dir_match(data_mpk_file_path, start_date, end_date, start_time = datetime.time(8, 0, 0), end_time = datetime.time(15, 15, 0), time_frame_length = 5, rolling_step = '1T', output_excel_path= r"C:\Users\achen\Desktop\Monocular\rolling_pairwise_theo_diff_corr.xlsx"):
...
#                    single_column.append(corr)
                    score = 0
                    for i in range(len(first_time_move_list)):
                        if first_time_move_list[i] >= 60:
                            if second_time_move_list[i] >= 60:
                                score += 1
                            if second_time_move_list[i] <= -60:
                                score = score - 1
                        if first_time_move_list[i] <= -60:
